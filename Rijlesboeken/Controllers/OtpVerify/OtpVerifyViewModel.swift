...
//    public static func AddUserData(api:String,parameters:[String:Any],completion:@escaping(sendOtpdataStruct?)->Void){
//        ApiService.shared.mobileApiRequest(api: api, method: .post, parameters: parameters) {
//            (data, val, error) in
//            guard let data = data else { return }
//            do{
//                let res = try
//                    JSONDecoder().decode(sendOtpdataStruct.self, from: data)
//                completion(res)
//            }catch{
//                completion(nil)
